...
// Position index
//
// Built on demand by the functions that need O(1) coordinate-to-ship lookup.
 ...
 * @param positionIndex Pre-built coordinate-to-ship lookup from buildPositionIndex.
 */
